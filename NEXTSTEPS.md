...
# Next Steps for ndx-moseq Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-moseq directory.
...
`spec/ndx-moseq.namespace.yaml` and
`spec/ndx-moseq.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-moseq
...
`staged-extensions/ndx-moseq`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-moseq
    ```

13. Edit `staged-extensions/ndx-moseq/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-moseq
      version: 0.1.0
      src: https://github.com/pauladkisson/ndx-moseq
      pip: https://pypi.org/project/ndx-moseq/
      license: BSD-3
      maintainers: 
        - pauladkisson
      ```

14. Edit `staged-extensions/ndx-moseq/README.md`
to add information about your extension. You may copy it from
`ndx-moseq/README.md`.

  ```bash
  cp ndx-moseq/README.md staged-extensions/ndx-moseq/README.md
  ```
...
git add ndx-moseq
git commit -m "Add new catalog entry for ndx-moseq" .
git push
```
...
ndx-moseq-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-moseq GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-moseq-record repository on GitHub.
