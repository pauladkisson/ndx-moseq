...
# Next Steps for ndx-depth-moseq Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-depth-moseq directory.
...
`spec/ndx-depth-moseq.namespace.yaml` and
`spec/ndx-depth-moseq.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-depth-moseq
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/pauladkisson/ndx-depth-moseq/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-depth-moseq/0.1.0
...
`staged-extensions/ndx-depth-moseq`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-depth-moseq
    ```

13. Edit `staged-extensions/ndx-depth-moseq/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/pauladkisson/ndx-depth-moseq
      pip: https://pypi.org/project/ndx-depth-moseq/
      license: BSD-3
      maintainers: 
        - pauladkisson
      ```

14. Edit `staged-extensions/ndx-depth-moseq/README.md`
to add information about your extension. You may copy it from
`ndx-depth-moseq/README.md`.

  ```bash
  cp ndx-depth-moseq/README.md staged-extensions/ndx-depth-moseq/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-depth-moseq
git commit -m "Add new catalog entry for ndx-depth-moseq" .
git push
```
...
ndx-depth-moseq-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-depth-moseq GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-depth-moseq-record repository on GitHub.
